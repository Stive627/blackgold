...
function Product({products, setProducts}) {
  ...
  return (
    <div className=' w-screen flex justify-center'>
      <div style={{width:'98%'}} className={`grid gap-3 mt-3 ${width <1700 && width >1200 && 'grid-cols-4'} ${width <1200 && width >860 && 'grid-cols-3'} ${width <860 && 'grid-cols-2'} ${width>=1700 && 'grid-cols-5'}`}>
