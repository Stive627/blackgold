...
function AnimationSeasonal({imgSeasonal}) {
  ...
  return (
    <div style={{position:'relative', overflowX:'hidden', top:large?'':width<402?'-20px':'-30px', bottom:large? '50px':'', right:large?'20px':large <402 ?'-12px':'', width:large?'650px':large>750?'900px':'256px', height:large?'206px':'150px', border:'2px', borderRadius:'9px'}}>
