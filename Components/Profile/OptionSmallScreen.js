...
function OptionSmallScreen() {
  ...
  return (
    <div  className='relative '>
        <div style={{border:`1px rgba(67, 67, 67, 0.81) solid`, height:expand ?'90px':'30px', padding:5, transition:'500ms', }} className=' flex flex-row items-start gap-2 bg-white rounded-md absolute right-0 border overflow-hidden'>
