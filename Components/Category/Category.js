    ...
    <div className=' flex justify-center'>
        <div style={{width:'98%'}} className=' w-full flex justify-center mt-2 '>
            <div className=' flex justify-between gap-2'>
                <CategoryCard title={'Farm-Fresh'} subTitle={!smallscreen ?'Ripe, delicious, and straight from the source!':''}  handleClick={()=>console.log()} img={'https://blackgoldapi.tsasoft.com/Fruits.jpg'}/>
